...
(function (e, t) {
    ...
    'use strict';
    var m = String.prototype, b = Math.max, y = Math.min, w = Math.floor, v = Math.ceil;
    ...
    var S, x, k,
        ...
        }), E = {}.propertyIsEnumerable, R = Object.getOwnPropertyDescriptor, _ = R && !E.call({1: 2}, 1),
        N = _ ? function (e) {
            var t = R(this, e);
        ...
        ce = "function" == typeof re && /native code/.test(le.call(re)), de = 0, O = Math.random(), pe = function (e) {
    ...
    var xe = {
            ...
            se("inspectSource", function (e) {
                ...
                var s = !!i && !!i.unsafe, l = !!i && !!i.enumerable, r = !!i && !!i.noTargetGet;
            ...
            return function (t, o, a) {
                ...
                if (e && o != o) {
                    for (; s > l;) if (n = i[l++], n != n) return !0;
                } else for (; s > l; l++) if ((e || l in i) && i[l] === o) return e || l || 0;
                return !e && -1
            }
        }, Ee = {includes: Ae(!0), indexOf: Ae(!1)}, Re = Ee.indexOf, _e = function (e, t) {
            var o, a = M(e), n = 0, s = [];
        ...
        Fe = Ne.concat("length", "prototype"), De = Object.getOwnPropertyNames || function (e) {
            return _e(e, Fe)
        }, Le = {f: De}, Ve = Object.getOwnPropertySymbols, Be = {f: Ve}, He = Oe("Reflect", "ownKeys") || function (e) {
        ...
        }, ze = Ue.data = {}, Ge = Ue.NATIVE = "N", We = Ue.POLYFILL = "P", Ye = Ue, Ke = Z.f, Xe = function (e, t) {
            var o, a, n, i, s, l, r = e.target, c = e.global, d = e.stat;
            if (a = c ? C : d ? C[r] || ie(r, {}) : (C[r] || {}).prototype, a) for (n in t) {
            ...
            return e
        }, ot = Oe("document", "documentElement"), at = he("IE_PROTO"), nt = "prototype", it = function () {
        }, st = function () {
    ...
    var rt = Le.f, ct = {}.toString,
        ...
        pt = function (e) {
            ...
            e && !G(e = o ? e : e.prototype, vt) && wt(e, vt, {configurable: !0, value: t})
        }, xt = function (e) {
            ...
            return function (n, i, s, l) {
                for (var r, c, d = Ze(n), p = B(d), u = kt(i, s, 3), h = Ie(p.length), g = 0, f = l || Pt, m = t ? f(n, h) : 2 == e ? f(n, 0) : void 0; h > g; g++) if ((5 == e || a || g in p) && (r = p[g], c = u(r, g, d), e)) if (t) m[g] = c; else if (c) switch (e) {
                    case 3:
                        return !0;
                    case 5:
                        return r;
        ...
        }, It = {forEach: Ct(0), map: Ct(1), filter: Ct(2), some: Ct(3), every: Ct(4), find: Ct(5), findIndex: Ct(6)},
        $t = It.forEach, At = he("hidden"), Et = "Symbol", Rt = "prototype", _t = ft("toPrimitive"), Nt = xe.set,
        Ft = xe.getterFor(Et), Dt = Object[Rt], Lt = C.Symbol, Vt = C.JSON, Bt = Vt && Vt.stringify, Ht = Z.f,
        jt = ae.f, Mt = ut.f, Ut = f.f, qt = se("symbols"), zt = se("op-symbols"), Gt = se("string-to-symbol-registry"),
        Wt = se("symbol-to-string-registry"), Yt = se("wks"), Kt = C.QObject, Xt = !Kt || !Kt[Rt] || !Kt[Rt].findChild,
        Qt = A && I(function () {
            return 7 != lt(jt({}, "a", {
                get: function () {
            ...
            var o = qt[e] = lt(Lt[Rt]);
            return Nt(o, {type: Et, tag: e, description: t}), A || (o.description = t), o
            ...
            e === Dt && eo(zt, t, o), ee(e);
            var a = q(t, !0);
            return ee(o), G(qt, a) ? (o.enumerable ? (G(e, At) && e[At][a] && (e[At][a] = !1), o = lt(o, {enumerable: F(0, !1)})) : (!G(e, At) && jt(e, At, F(1, {})), e[At][a] = !0), Qt(e, a, o)) : jt(e, a, o)
        }, to = function (e, t) {
            ee(e);
    ...
    Qe || (Lt = function () {
        ...
        var e = arguments.length && void 0 !== arguments[0] ? arguments[0] + "" : void 0, t = pe(e), o = function (e) {
    ...
    }), ke(Dt, "propertyIsEnumerable", oo, {unsafe: !0})), mt.f = function (e) {
        return Jt(ft(e), e)
    }), Xe({global: !0, wrap: !0, forced: !Qe, sham: !Qe}, {Symbol: Lt}), $t(et(Yt), function (e) {
        yt(e)
        ...
        }, defineProperty: eo, defineProperties: to, getOwnPropertyDescriptor: ao
    ...
    if (A && "function" == typeof lo && (!("description" in lo.prototype) || void 0 !== lo().description)) {
        ...
        po.constructor = co;
        var uo = po.toString, ho = "Symbol(test)" == lo("test") + "", go = /^Symbol\((.*)\)[^)]+$/;
        so(po, "description", {
    ...
    var fo = function (e, t, o) {
        ...
        }, yo = ft("isConcatSpreadable"), wo = 9007199254740991, vo = "Maximum allowed index exceeded",
        So = !I(function () {
            var e = [];
    ...
    Xe({target: "Array", proto: !0, forced: !So || !xo}, {
        concat: function () {
            ...
            for (e = -1, o = arguments.length; e < o; e++) if (s = -1 === e ? l : arguments[e], ko(s)) {
    ...
    }, Do = Ee.indexOf, Lo = [].indexOf, Vo = !!Lo && 0 > 1 / [1].indexOf(1, -0), Bo = Fo("indexOf");
    ...
    }), qo = he("IE_PROTO"), zo = Object.prototype, Go = Uo ? Object.getPrototypeOf : function (e) {
    ...
    var Ko = {IteratorPrototype: Ho, BUGGY_SAFARI_ITERATORS: Yo}, Xo = Ko.IteratorPrototype, Qo = function (e, t, o) {
        ...
        }() : void 0), ea = Ko.IteratorPrototype, ta = Ko.BUGGY_SAFARI_ITERATORS, oa = ft("iterator"), aa = "keys",
        na = "values", ia = "entries", sa = function () {
            return this
            ...
            var l, r, c, d = function (e) {
                ...
                }, p = !1, u = e.prototype, h = u[oa] || u["@@iterator"] || n && u[n], g = !ta && h || d(n),
            ...
            if (f && (l = Go(f.call(new e)), ea !== Object.prototype && l.next && (Go(l) !== ea && (Zo ? Zo(l, ea) : "function" != typeof l[oa] && ne(l, oa, sa)), St(l, t + " Iterator", !0))), n == na && h && h.name !== na && (p = !0, g = function () {
                return h.call(this)
            }), u[oa] !== g && ne(u, oa, g), n) if (r = {
                values: d(na),
                keys: i ? g : d(aa),
                entries: d(ia)
            }, s) for (c in r) (ta || p || !(c in u)) && ke(u, c, r[c]); else Xe({
                target: t,
                proto: !0,
                forced: ta || p
            }, r);
            return r
        }, ra = "Array Iterator", ca = xe.set, da = xe.getterFor(ra), pa = la(Array, "Array", function (e, t) {
            ca(this, {type: ra, target: M(e), index: 0, kind: t})
        }, function () {
            var e = da(this), t = e.target, o = e.kind, a = e.index++;
            return !t || a >= t.length ? (e.target = void 0, {value: void 0, done: !0}) : "keys" == o ? {
                value: a,
                done: !1
            } : "values" == o ? {value: t[a], done: !1} : {value: [a, t[a]], done: !1}
        }, "values");
    ...
    Xe({target: "Array", proto: !0, forced: !bo("slice")}, {
        slice: function (e, t) {
            var o, a, i, s = M(this), l = Ie(s.length), r = $e(e, l), c = $e(void 0 === t ? l : t, l);
    ...
    Xe({target: "Array", proto: !0, forced: !bo("splice")}, {
        splice: function (e, t) {
            var o, a, n, i, s, l, r = Ze(this), c = Ie(r.length), d = $e(e, c), p = arguments.length;
            ...
            } else if (o > a) for (i = c - a; i > d; i--) s = i + a - 1, l = i + o - 1, s in r ? r[l] = r[s] : delete r[l];
    ...
    var xa = function (e, t, o) {
        ...
        ka = "\t\n\x0B\f\r \xA0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF",
        Ta = "[" + ka + "]", Pa = RegExp("^" + Ta + Ta + "*"), Oa = RegExp(Ta + Ta + "*$"), Ca = function (e) {
            return function (t) {
                var o = H(t) + "";
                return 1 & e && (o = o.replace(Pa, "")), 2 & e && (o = o.replace(Oa, "")), o
            }
        }, Ia = {start: Ca(1), end: Ca(2), trim: Ca(3)}, $a = Le.f, Aa = Z.f, Ea = ae.f, Ra = Ia.trim, _a = "Number",
        Na = C[_a], Fa = Na.prototype, Da = L(lt(Fa)) == _a, La = function (e) {
            var t, o, a, n, i, s, l, r, c = q(e, !1);
            if ("string" == typeof c && 2 < c.length) if (c = Ra(c), t = c.charCodeAt(0), 43 === t || 45 === t) {
                ...
                for (i = c.slice(2), s = i.length, l = 0; l < s; l++) if (r = i.charCodeAt(l), 48 > r || r > n) return NaN;
                return parseInt(i, a)
            }
            return +c
        };
    ...
    var Ma = Object.assign, Ua = !Ma || I(function () {
        ...
        for (var t = Ze(e), o = arguments.length, a = 1, n = Be.f, i = f.f; o > a;) for (var s, l = B(arguments[a++]), r = n ? et(l).concat(n(l)) : et(l), c = r.length, d = 0; c > d;) s = r[d++], (!A || i.call(l, s)) && (t[s] = l[s]);
        return t
    } : Ma;
    ...
    var on = Ia.trim, an = C.parseFloat, nn = 1 / an(ka + "-0") != -Infinity, sn = nn ? function (e) {
        var t = on(e + ""), o = an(t);
        return 0 === o && "-" == t.charAt(0) ? -0 : o
    } : an;
    Xe({global: !0, forced: parseFloat != sn}, {parseFloat: sn});
    var ln = Ia.trim, rn = C.parseInt, cn = /^[+-]?0[Xx]/, dn = 8 !== rn(ka + "08") || 22 !== rn(ka + "0x16"),
        pn = dn ? function (e, t) {
            var o = ln(e + "");
    ...
    var xn = function (e) {
        ...
        }, kn = {codeAt: xn(!1), charAt: xn(!0)}, Tn = kn.charAt, Pn = "String Iterator", On = xe.set,
        Cn = xe.getterFor(Pn);
    la(String, "String", function (e) {
        On(this, {type: Pn, string: e + "", index: 0})
    }, function () {
        var e, t = Cn(this), o = t.string, a = t.index;
        return a >= o.length ? {value: void 0, done: !0} : (e = Tn(o, a), t.index += e.length, {value: e, done: !1})
    });
    ...
    var _n = An, Nn = ft("species"), Fn = !I(function () {
        ...
        return _n.call(e, t)
    }, jn = /\$([$&'`]|\d\d?|<[^>]*>)/g, Mn = /\$([$&'`]|\d\d?)/g, Un = function (e) {
        return void 0 === e ? e : e + ""
    };
    Ln("replace", 2, function (e, t, o) {
        ...
        return [function (o, a) {
            ...
            for (var u, h, g = []; (u = Hn(l, r), null !== u) && (g.push(u), !!d);) h = u[0] + "", "" == h && (l.lastIndex = Bn(r, Ie(l.lastIndex), p));
    ...
    Ln("split", 2, function (e, t, o) {
        ...
        return a = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || 1 < ".".split(/()()/).length || "".split(/.?/).length ? function (e, o) {
            ...
            for (var i, s, l, r = [], c = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e.sticky ? "y" : ""), d = 0, p = new RegExp(e.source, c + "g"); (i = _n.call(p, a)) && (s = p.lastIndex, !(s > d && (r.push(a.slice(d, i.index)), 1 < i.length && i.index < a.length && Wn.apply(r, i.slice(1)), l = i[0].length, d = s, r.length >= n)));) p.lastIndex === i.index && p.lastIndex++;
            ...
            var r = ee(n), c = this + "", d = Gn(r, RegExp), u = r.unicode,
                ...
                g = new d(Kn ? r : "^(?:" + r.source + ")", h), f = void 0 === s ? Yn : s >>> 0;
            if (0 === f) return [];
            if (0 === c.length) return null === Hn(g, c) ? [c] : [];
            for (var m = 0, b = 0, w = []; b < c.length;) {
                g.lastIndex = Kn ? b : 0;
                var v, S = Hn(g, Kn ? c : c.slice(b));
                if (null === S || (v = y(Ie(g.lastIndex + (Kn ? 0 : b)), c.length)) === m) b = Bn(c, b, u); else {
                    if (w.push(c.slice(m, b)), w.length === f) return w;
                    for (var x = 1; x <= S.length - 1; x++) if (w.push(S[x]), w.length === f) return w;
                    b = m = v
                }
            }
    ...
    for (var si in Qn) {
        ...
        if (ri) {
            ...
            if (ri[ni] || ne(ri, ni, si), Qn[si]) for (var ci in pa) if (ri[ci] !== pa[ci]) try {
                ne(ri, ci, pa[ci])
            } catch (e) {
                ri[ci] = pa[ci]
            }
    ...
    var fi = {
        ...
        for (var r, c = n, d = 0, p = !!s && kt(s, l, 3); d < a;) {
            if (d in o) {
                if (r = p ? p(o[d], d, t) : o[d], 0 < i && Je(r)) c = mi(e, t, r, Ie(r.length), c, i - 1) - 1; else {
    ...
    Xe({target: "Array", proto: !0}, {
        flat: function () {
            var e = arguments.length ? arguments[0] : void 0, t = Ze(this), o = Ie(t.length), a = Pt(t, 0);
    ...
    var yi = {
        sprintf: function (e) {
            ...
            try {
                for (var i, s, l = e[Symbol.iterator](); !(o = (i = l.next()).done); o = !0) if (s = i.value, s.field === t) return s.title
            } catch (e) {
                a = !0, n = e
            } finally {
                try {
            ...
            for (var h = 0; h < e.length; h++) {
                ...
                try {
                    for (var b, y = e[h][Symbol.iterator](); !(g = (b = y.next()).done); g = !0) {
                        var w = b.value, r = w.rowspan || 1, v = w.colspan || 1, S = o[h].indexOf(!1);
            ...
            try {
                for (var s, l = e[Symbol.iterator](); !(o = (s = l.next()).done); o = !0) {
                    ...
                    try {
                        for (var h, g, f = d[Symbol.iterator](); !(c = (h = f.next()).done); c = !0) if (g = h.value, 1 < g.colspanGroup) {
            ...
            for (var i, s = 0, l = a; s < l.length; s++) if (i = l[s], n.includes(i) && e[i] !== t[i]) return !1;
            return !0
            ...
            for (var t = 0, o = Object.entries(e); t < o.length; t++) {
                var a = l(o[t], 2), n = a[0], i = a[1], s = n.split(/(?=[A-Z])/).join("-").toLowerCase();
            ...
            var o = !0, a = !1, n = void 0;
            try {
                for (var i, s, l = e[Symbol.iterator](); !(o = (i = l.next()).done); o = !0) if (s = i.value, JSON.stringify(s) === JSON.stringify(t)) return e.indexOf(s)
            } catch (e) {
                a = !0, n = e
            } finally {
                try {
            ...
            return o.each(function (o, s) {
                ...
                l._id = t(s).attr("id"), l._class = t(s).attr("class"), l._data = a.getRealDataAttr(t(s).data()), t(s).find(">td,>th").each(function (n, s) {
                    ...
                    for (var p = d; p < d + r; p++) for (var u = o; u < o + c; u++) i[u] || (i[u] = []), i[u][p] = !0;
                    var h = e[d].field;
        ...
        return s(e, [{
            key: "initDOM", value: function (e) {
                ...
                var t = this.initData(e, this.getNum()), o = t.rows.join(""), a = this.checkChanges("data", o),
                    n = this.checkChanges("top", t.topOffset), i = this.checkChanges("bottom", t.bottomOffset), s = [];
            ...
            key: "initData", value: function (e, t) {
                if (e.length < wi) return {topOffset: 0, bottomOffset: 0, rowsAbove: 0, rows: e};
                var o = b((this.clusterRows - wi) * t, 0), a = o + this.clusterRows, n = b(o * this.itemHeight, 0),
        ...
        return s(e, [{
            ...
            key: "initLocale", value: function () {
                if (this.options.locale) {
                    var e = t.fn.bootstrapTable.locales, o = this.options.locale.split(/-|_/);
            ...
            key: "initHeader", value: function () {
                ...
                this.header = {
                    ...
                    n.push("<tr>"), 0 === t && !o.options.cardView && o.options.detailView && o.options.detailViewIcon && n.push("<th class=\"detail\" rowspan=\"".concat(o.options.columns.length, "\">\n          <div class=\"fht-cell\"></div>\n          </th>\n        ")), e.forEach(function (e, i) {
                        if (e.visible) {
                            var s = yi.sprintf(" class=\"%s\"", e["class"]), l = e.widthUnit, r = parseFloat(e.width),
                            ...
                            var u = o.options.escape ? yi.escapeHTML(e.title) : e.title, h = u;
            ...
            key: "initSort", value: function () {
                ...
                -1 !== n && (this.options.sortStable && this.data.forEach(function (e, t) {
                    ...
                    var s = yi.getItemField(i, t, e.options.escape), l = yi.getItemField(a, t, e.options.escape),
            ...
            key: "onSort", value: function (e) {
                var o = e.type, a = e.currentTarget, n = "keypress" === o ? t(a) : t(a).parent(),
            ...
            key: "initToolbar", value: function () {
                ...
                if (o.push("</div>"), (this.showToolbar || 2 < o.length) && this.$toolbar.append(o.join("")), l.showPaginationSwitch && this.$toolbar.find("button[name=\"paginationSwitch\"]").off("click").on("click", function () {
                    ...
                    var d = e.find("input:not(\".toggle-all\")"), p = e.find("input.toggle-all");
                ...
                if (l.search) {
                    ...
                    n.off(b).on(b, function (e) {
                        ...
                        s.resetSearch(), s.onSearch({currentTarget: s.$toolbar.find(".search input")})
                    })
                }
            }
        }, {
            key: "onSearch", value: function () {
                var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, o = e.currentTarget,
                    a = e.firedByInitSearchText, n = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1];
                if (void 0 !== o && n) {
                    var i = t(o).val().trim();
            ...
            key: "initSearch", value: function () {
                ...
                if (this.filterOptions = this.filterOptions || this.options.filterOptions, "server" !== this.options.sidePagination) {
                    ...
                    "function" == typeof this.filterOptions.filterAlgorithm ? this.data = this.options.data.filter(function (t) {
                        ...
                        if ("and" === a) {
                            for (var n in o) if (Array.isArray(o[n]) && !o[n].includes(t[n]) || !Array.isArray(o[n]) && t[n] !== o[n]) return !1;
                        } else if ("or" === a) {
                            var i = !1;
                    ...
                    this.data = t ? this.data.filter(function (o, n) {
                        for (var i = 0; i < e.header.fields.length; i++) if (e.header.searchables[i] && (!e.options.visibleSearch || -1 !== a.indexOf(e.header.fields[i]))) {
                            ...
                            if (l && l.searchFormatter && (r = yi.calculateObjectValue(l, e.header.formatters[i], [r, o, n, l.field], r)), "string" == typeof r || "number" == typeof r) if (!e.options.strictSearch) {
                                var p = /(?:(<=|=>|=<|>=|>|<)(?:\s+)?(\d+)?|(\d+)?(\s+)?(<=|=>|=<|>=|>|<))/gm,
                                    u = p.exec(t), h = !1;
                                if (u) {
                                    var g = u[1] || "".concat(u[5], "l"), f = u[2] || u[3], m = parseInt(r, 10),
                                        b = parseInt(f, 10);
                                    switch (g) {
                                        case">":
                                        case"<l":
            ...
            key: "initPagination", value: function () {
                ...
                var o, n, s, l, r, c, d, p = [], u = !1, h = this.getData({includeHiddenRows: !1}), g = a.pageList;
                if ("server" !== a.sidePagination && (a.totalRows = h.length), this.totalPages = 0, a.totalRows) {
                    if (a.pageSize === a.formatAllRows()) a.pageSize = a.totalRows, u = !0; else if (a.pageSize === a.totalRows) {
            ...
            key: "initRow", value: function (e, t) {
                ...
                if (!(-1 < yi.findIndex(this.hiddenRows, e))) {
                    if (i = yi.calculateObjectValue(this.options, this.options.rowStyle, [e, t], i), i && i.css) for (var p = 0, u = Object.entries(i.css); p < u.length; p++) {
                        var h = l(u[p], 2), g = h[0], f = h[1];
                        s.push("".concat(g, ": ").concat(f))
                    }
                    if (c = yi.calculateObjectValue(this.options, this.options.rowAttributes, [e, t], c), c) for (var m = 0, b = Object.entries(c); m < b.length; m++) {
                        var y = l(b[m], 2), g = y[0], f = y[1];
                        d.push("".concat(g, "=\"").concat(yi.escapeHTML(f), "\""))
                    }
                    if (e._data && !yi.isEmptyObject(e._data)) for (var w = 0, S = Object.entries(e._data); w < S.length; w++) {
                    ...
                    return n.push("<tr", yi.sprintf(" %s", d.length ? d.join(" ") : void 0), yi.sprintf(" id=\"%s\"", Array.isArray(e) ? void 0 : e._id), yi.sprintf(" class=\"%s\"", i.classes || (Array.isArray(e) ? void 0 : e._class)), " data-index=\"".concat(t, "\""), yi.sprintf(" data-uniqueid=\"%s\"", yi.getItemField(e, this.options.uniqueId, !1)), yi.sprintf(" data-has-detail-view=\"%s\"", !this.options.cardView && this.options.detailView && yi.calculateObjectValue(null, this.options.detailFilter, [t, e]) ? "true" : void 0), yi.sprintf("%s", r), ">"), this.options.cardView && n.push("<td colspan=\"".concat(this.header.fields.length, "\"><div class=\"card-views\">")), !this.options.cardView && this.options.detailView && this.options.detailViewIcon && (n.push("<td>"), yi.calculateObjectValue(null, this.options.detailFilter, [t, e]) && n.push("\n          <a class=\"detail-icon\" href=\"#\">\n          ".concat(yi.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailOpen), "\n          </a>\n        ")), n.push("</td>")), this.header.fields.forEach(function (a, i) {
                        var r = "", d = yi.getItemField(e, a, o.options.escape), p = "", u = "", h = {}, g = "",
                            f = o.header.classes[i], m = "", b = "", y = "", w = "", S = "", x = o.columns[i];
                        if ((!o.fromHtml || "undefined" != typeof d || x.checkbox || x.radio) && x.visible && (!o.options.cardView || x.cardVisible)) {
                            ...
                            if (p = yi.calculateObjectValue(x, o.header.formatters[i], [d, e, t, a], d), e["_".concat(a, "_data")] && !yi.isEmptyObject(e["_".concat(a, "_data")])) for (var A = 0, E = Object.entries(e["_".concat(a, "_data")]); A < E.length; A++) {
                            ...
                            if (x.checkbox || x.radio) {
                                ...
                                var v = x["class"] || "", c = (!0 === p || d || p && p.checked) && !1 !== p,
            ...
            key: "initBody", value: function (e) {
                ...
                l ? this.options.virtualScroll ? (this.virtualScroll && this.virtualScroll.destroy(), this.virtualScroll = new Si({
                    ...
                    var e = t(a.currentTarget), n = e.parent(), i = t(a.target).parents(".card-views").children(),
                        s = t(a.target).parents(".card-view"), l = n.data("index"), r = o.data[l],
                        c = o.options.cardView ? i.index(s) : e[0].cellIndex, d = o.getVisibleFields(),
                        p = d[o.options.detailView && o.detailViewIcon && !o.options.cardView ? c - 1 : c],
                        u = o.columns[o.fieldsColumnsIndex[p]], h = yi.getItemField(r, p, o.options.escape);
                        ...
                        if (-1 !== s) {
                            ...
                            var l = function (e) {
                                ...
                                o.$body.find(">tr:not(.no-records-found)").each(function (n, l) {
                                    var r = t(l), c = r.find(o.options.cardView ? ".card-view" : "td").eq(s),
                                        d = e.indexOf(" "), p = e.substring(0, d), u = e.substring(d + 1);
            ...
            key: "initServer", value: function (e, o, a) {
                var n = this, i = {}, s = this.header.fields.indexOf(this.options.sortName), l = {
            ...
            key: "fitHeader", value: function () {
                ...
                p.find("> *").each(function (o, a) {
                    ...
                    if (e.options.detailView && e.options.detailViewIcon && !e.options.cardView) {
                        if (0 === o) {
                            var s = d.filter(".detail"), l = s.width() - s.find(".fht-cell").width();
                    ...
                    try {
                        for (var i, s = this.columns[Symbol.iterator](); !(o = (i = s.next()).done); o = !0) {
                            ...
                            if (r.visible) {
                                ...
                                if (c = yi.sprintf("text-align: %s; ", r.falign ? r.falign : r.align), d = yi.sprintf("vertical-align: %s; ", r.valign), u = yi.calculateObjectValue(null, this.options.footerStyle, [r]), u && u.css) for (var g = 0, f = Object.entries(u.css); g < f.length; g++) {
            ...
            key: "fitFooter", value: function () {
                ...
                l.find("> *").each(function (o, a) {
                    ...
                    if (e.options.detailView && !e.options.cardView) {
                        if (0 === o) {
                            var l = s.filter(".detail"), r = l.width() - l.find(".fht-cell").width();
            ...
            key: "getRowByUniqueId", value: function (e) {
                var t, o, a, n = this.options.uniqueId, s = this.options.data.length, l = e, r = null;
                for (t = s - 1; 0 <= t; t--) {
                    if (o = this.options.data[t], o.hasOwnProperty(n)) a = o[n]; else if (o._data && o._data.hasOwnProperty(n)) a = o._data[n]; else continue;
            ...
            key: "updateByUniqueId", value: function (e) {
                var o = Array.isArray(e) ? e : [e], a = !0, n = !1, i = void 0;
                try {
                    for (var s, l, r = o[Symbol.iterator](); !(a = (s = r.next()).done); a = !0) if (l = s.value, l.hasOwnProperty("id") && l.hasOwnProperty("row")) {
            ...
            key: "updateCellByUniqueId", value: function (e) {
                ...
                if (e.hasOwnProperty("id") && e.hasOwnProperty("field") && e.hasOwnProperty("value")) {
                    ...
                    o.forEach(function (e) {
                        var o = e.id, a = e.field, n = e.value, i = t.options.data.indexOf(t.getRowByUniqueId(o));
            ...
            key: "_toggleAllColumns", value: function (e) {
                ...
                try {
                    for (var s, l, r = this.columns.slice().reverse()[Symbol.iterator](); !(a = (s = r.next()).done); a = !0) if (l = s.value, l.switchable) {
            ...
            key: "mergeCells", value: function (e) {
                var t, o, a = e.index, n = this.getVisibleFields().indexOf(e.field), s = e.rowspan || 1,
                    l = e.colspan || 1, r = this.$body.find(">tr");
                this.options.detailView && !this.options.cardView && (n += 1);
                var c = r.eq(a).find(">td").eq(n);
                if (!(0 > a || 0 > n || a >= this.data.length)) {
                    for (t = a; t < a + s; t++) for (o = n; o < n + l; o++) r.eq(t).find(">td").eq(o).hide();
            ...
            key: "_toggleCheck", value: function (e, t) {
                var o = this.$selectItem.filter("[data-index=\"".concat(t, "\"]")), a = this.data[t];
                ...
                if (a[this.header.stateField] = e, this.options.multipleSelectRow) {
                    if (this.multipleSelectRowShiftKey && 0 <= this.multipleSelectRowLastSelectedIndex) for (var u = [this.multipleSelectRowLastSelectedIndex, t].sort(), h = u[0] + 1; h < u[1]; h++) this.data[h][this.header.stateField] = !0, this.$selectItem.filter("[data-index=\"".concat(h, "\"]")).prop("checked", !0);
            ...
            key: "resetView", value: function (e) {
                ...
                if (e && e.height && (this.options.height = e.height), this.$selectAll.prop("checked", 0 < this.$selectItem.length && this.$selectItem.length === this.$selectItem.filter(":checked").length), this.$tableContainer.toggleClass("has-card-view", this.options.cardView), !this.options.cardView && this.options.showHeader && this.options.height ? (this.$tableHeader.show(), this.resetHeader(), t += this.$header.outerHeight(!0)) : (this.$tableHeader.hide(), this.trigger("post-header")), !this.options.cardView && this.options.showFooter && (this.$tableFooter.show(), this.fitFooter(), this.options.height && (t += this.$tableFooter.outerHeight(!0))), this.options.height) {
                    var o = this.$toolbar.outerHeight(!0), a = this.$pagination.outerHeight(!0),
                        n = this.options.height - o - a, i = this.$tableBody.find("table").outerHeight(!0);
    ...
    return xi.VERSION = fi.VERSION, xi.DEFAULTS = fi.DEFAULTS, xi.LOCALES = fi.LOCALES, xi.COLUMN_DEFAULTS = fi.COLUMN_DEFAULTS, xi.METHODS = fi.METHODS, xi.EVENTS = fi.EVENTS, t.BootstrapTable = xi, t.fn.bootstrapTable = function (e) {
        ...
        return this.each(function (o, i) {
            var l = t(i).data("bootstrap.table"), r = t.extend({}, xi.DEFAULTS, t(i).data(), "object" === a(e) && e);
            if ("string" == typeof e) {
                var c;
